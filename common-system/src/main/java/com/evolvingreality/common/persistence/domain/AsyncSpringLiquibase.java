...
public class AsyncSpringLiquibase extends SpringLiquibase {
    ...
    @Autowired
    public AsyncSpringLiquibase(final TaskExecutor taskExecutor, final Environment environment) {
    ...
    public void afterPropertiesSet() throws LiquibaseException {
        if (environment.acceptsProfiles(SpringProfiles.LIQUIBASE.getProfile())) {
            if (environment.acceptsProfiles(SpringProfiles.DEVELOPMENT.getProfile())) {
